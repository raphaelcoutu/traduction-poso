...
func TestTransform(t *testing.T) {
	testCases := []struct {
		...
		{
			input:    "TAKE 1 CAPSULE (100 MG TOTAL) BY MOUTH 2 (TWO) TIMES A DAY ONE PILL TWICE A DAY WITH A SMALL AMOUNT OF NON-DAIRY FOOD",
			expected: "PRENDRE 1 CAPSULE (100 MG) PAR LA BOUCHE 2 FOIS PAR JOUR UNE PILULE 2 FOIS PAR JOUR AVEC UN PEU DE NOURRITURE SANS PRODUITS LAITIERS",
		},
	}
